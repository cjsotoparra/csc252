...
.text
	...
	la	$t0, x_ARRAY_1		# t0 = array_1

	la	$t1, x_ARRAY_1_END	# t1 = array_1_end
	sub	$t1, $t1, $t0		# t1 = array_1_end - array_1 (in bytes)
	srl	$t1, $t1, 2		# t1 = len_1

	la	$t2, x_ARRAY_2		# t2 = array_2

	la	$t3, x_ARRAY_2_END	# t2 = array_2_end
	sub	$t3, $t3, $t2		# t3 = array_2_end - array_2 (in bytes)
	srl	$t3, $t3, 2		# t3 = len_2


	# mergePrint(array_1,len_1, array_2,len_2)
	add	$a0, $t0, $zero
	add	$a1, $t1, $zero
	add	$a2, $t2, $zero
	add	$a3, $t3, $zero
...
.text
	...
	la	$t0, x_JUNK_VALUES		# t0 = &JUNK_VALUES
